...
Zimbra Collaboration is the world’s leading open source messaging and collaboration solution, trusted by more than 5,000 Enterprises, Public Sector organizations and Service Providers, providing mailbox services for hundereds of millions of end users, in over 140 countries.
